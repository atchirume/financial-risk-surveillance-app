...
st.markdown("""
This application is a prototype analytical tool developed for research, demonstration, and decision-support purposes only.

It does not constitute a production-ready financial crime detection system and should not be relied upon as the sole basis for regulatory, compliance, or legal decisions.

All outputs generated by the system are indicative and require validation, interpretation, and confirmation by qualified professionals.

The developer assumes no liability for any decisions made based on the outputs of this application.

Users are responsible for ensuring compliance with applicable data protection, confidentiality, and regulatory requirements.
""")
